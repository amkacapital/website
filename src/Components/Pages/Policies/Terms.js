...
export default function PrivacyPolicy() {
  return (
    <div id="conditions">
      <div className="flex items-end terms-bg pt5">
        <p className="f2 b white pl4">Terms of Service</p>
      </div>
      <div className="tl ph5 mt2">
        <p>
          This website is operated by Amka Capital Services. Throughout the
          site, the terms “we”, “us” and “our” refer to Amka Capital Services.
          Amka Capital Services offers this website, including all information,
        ...
        <p>
          When you submit the form from our website, as part of to contact in
          future, we collect the personal information you give us such as your
          name, address and email address. Email marketing (if applicable): With
          your permission, we may send you emails about our store, new products
          and other updates.
        </p>

        <p className="b">SECTION 1 - ONLINE TERMS</p>
        ...
        <p>
          ...
          minor dependents to use this site. You may not use our service for any
        ...
        <p className="b">SECTION-2 GENERAL CONDITIONS</p>
        <p>
        ...
        <p>
          ...
          <br />
          <span className="b">SECTION 5 - PRODUCTS OR SERVICES </span>
          <br />
          Certain services may be available online through the website. These
          services may have limited offer. We do not warrant that the quality of
          ...
          <br />
          We reserve the right to refuse any request you place with us. We may, in
          our sole discretion. These restrictions may include orders
          placed by or under the same customer account, the same credit card,
          and/or orders that use the same billing. In
          ...
          <span className="b">SECTION 7 - OPTIONAL TOOLS</span>
          <br />
          ...
          <br />
          <span className="b">SECTION 8 - THIRD-PARTY LINKS</span>
          <br />
          ...
          <br />
          <span className="b">SECTION 12 - PROHIBITED USES</span>
          <br />
          ...
          non-infringement. In no case shall AMKA CAPITAL, our directors,
          ...
          <br />
          <span className="b">SECTION 14 - INDENIFICATION</span>
          <br />
          You agree to indemnify, defend and hold harmless AMKA CAPITAL and our
          ...
          <br />
          <span className="b">SECTION 15 - SEVERABILITY</span>
          <br />
          ...
          provisions.
          <br />
          <span className="b">SECTION 16 - TERMINATION</span>
          <br />
          ...
          <br />
          <span className="b">SECTION 17 - ENTIRE AGREEMENT</span>
          <br />
          ...
          party.
          <br />
          <span className="b">SECTION 18 - GOVERNING LAW</span>
          <br />
          These Terms of Service and any separate agreements whereby we provide
          you Services shall be governed by and construed in accordance with the
          laws of India and jurisdiction of Jaipur, Rajasthan
          <br />
          <span className="b">SECTION 19 - CHANGES TO TERMS OF SERVICE</span>
          <br />
          ...
          changes.
          <br />
          <span className="b">SECTION 20 - CONTACT INFORMATION</span>
          <br />
          Questions about the Terms of Service should be sent to us at
          amolkadam@amkacapital.com.
        </p>
      </div>
    </div>
  );
