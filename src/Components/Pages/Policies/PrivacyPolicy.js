...
export default function PrivacyPolicy() {
  return (
    <div id="policy">
      <div className="flex items-end policy-bg pt5">
        <p className="f2 b white pl4">Privacy Policy</p>
      </div>
      <div className="tl ph5 mt2">
        <p className="b">SECTION 1 - WHAT DO WE DO WITH YOUR INFORMATION?</p>
        <p>
          When you submit the form from our website, as part of to contact in future, we collect the personal information you give us such
          as your name, address and email address. Email marketing (if
          applicable): With your permission, we may send you emails about our
          store, new products and other updates.
        </p>

        <p className="b">SECTION 2 - CONSENT</p>

        <p>
          How do you get my consent?
          <br />
          When you provide us with personal information to complete a
          transaction, verify your credit card, we imply that you consent to our
        ...
        <p>
          ...
          disclosure of your information, at anytime, by mailing us
          at amolkadam@amkacapital.com
        </p>
        
          <p><span  className="b">SECTION 3 - DISCLOSURE</span><br/> We will never disclose your personal information.
        </p>
        <p>
          <span className="b">SECTION 4 - PAYMENT</span><br/> We use Razorpay for processing payments.
          We/Razorpay do not store your card data on their servers. The data is
          encrypted through the Payment Card Industry Data Security Standard
          (PCI-DSS) when processing payment. Your purchase transaction data is
          ...
          razorpay on https://razorpay.com <br/>
          
          <span className="b">SECTION 5 - THIRD-PARTY SERVICES</span><br/>
          ...
          <span className="b">SECTION 6 - SECURITY </span><br/>To protect your
          personal information, we take reasonable precautions and follow
          industry best practices to make sure it is not inappropriately lost,
          misused, accessed, disclosed, altered or destroyed. <br/>
          
          <span className="b">SECTION 7 -
          COOKIES</span> <br/>We use cookies to maintain session of your user. It is not
          used to personally identify you on other websites. <br/>
          
          <span className="b">SECTION 8 - AGE OF
          CONSENT<br/></span> By using this site, you represent that you are at least the
          ...
          <span className="b">SECTION 9 - CHANGES TO THIS PRIVACY POLICY</span><br/> We reserve
          ...
          upon their posting on the website. If we make material changes to this
          policy, we will notify you here that it has been updated, so that you
          are aware of what information we collect, how we use it, and under
          what circumstances, if any, we use and/or disclose it. If our company is
          acquired or merged with another company, your information may be
          transferred to the new owners so that we may continue the service
          to you. If you would like to: access, correct, amend or delete any
          ...
          at amolkadam@amkacapital.com<br/>
        </p>
      </div>
    </div>
  );
